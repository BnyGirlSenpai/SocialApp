...
// API endpoint to get all guests ids (invited and joined) for a given event //no caching
...
// API endpoint to get events the current user is an invited guest //no caching
...
// API endpoint to get event detail information //no caching
...
// API endpoint to get events curent user is owner //no caching
...
// API endpoint to get events the current user is a joined guest //no caching
...
// API endpoint to get public events with pagination //no caching   
